...
*For the results-first version of this post — full benchmark tables, the headline numbers, and the practical "what this means for you" guidance without the narrative — see [Batching Decode Attention Across Requests Got Us 3.83x Real Throughput — Across Layers Got Us Nothing](./crosslayer-decode-batching-results.md).*

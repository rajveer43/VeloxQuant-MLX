...
:::tip[New here?]
If you haven't decided whether you need cache compression at all, read [VeloxQuant-MLX vs. llama.cpp / plain mlx_lm](../getting-started/comparison) first — it explains what problem these 42 methods solve and when you don't need them.
:::

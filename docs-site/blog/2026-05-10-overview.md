...
description: "Introducing VeloxQuant-MLX: nine KV cache quantization algorithms with custom Metal kernels that cut Apple Silicon LLM memory use up to 16x."
date: 2026-05-10
authors: rajveer
